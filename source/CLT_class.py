...
def main_clt(parms_dict):
    ...
    print ("----------------------------------------------------")
    print ("Learning Chow-Liu Tree on original data ......      ")
    print ("----------------------------------------------------")
    clt = CLT()
    clt.learnStructure(data_train)
    
    
    train_ll = clt.computeLL(data_train) / data_train.shape[0]
    ...
    print('Train set LL score: ', train_ll)    
